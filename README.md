...
[![build status](https://github.com/aamsur-mkt/mkommon/common/badges/master/build.svg)](https://github.com/aamsur-mkt/mkommon/common/commits/master) [![coverage report](https://github.com/aamsur-mkt/mkommon/common/badges/master/coverage.svg)](https://github.com/aamsur-mkt/mkommon/common/commits/master)
...
## Installation
```bash
- go get github.com/aamsur-mkt/mkommon/common
```
